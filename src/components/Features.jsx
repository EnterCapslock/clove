...
import styles from "../css modules/Features.module.css"; // Adjust path as needed
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <p className={styles.featuresParagraph}>
                Experience a transformative learning journey tailored just for you. 
                Our innovative approach ensures that every learner receives 
            ...
            <div className="col-md-4 d-flex align-items-stretch">
              <div className={styles.featureCard}>
                ...
                <p className={styles.featureDescription}>
                  Our system creates unique learning paths based on individual progress.
                </p>
              </div>
            </div>
